#ifndef dL_1401
#define dL_1401
static const char L_1401[]="Unknown relocation type: %d";
static const char L_1402[]="Unknown relocation type: %d";
static const char L_1403[]="DLLs unimplemented!";
static const char L_1404[]="reloc %d: x=0x%x val=0x%x ";
static const char L_1405[]=" newx=0x%x name=%s\n";
static const char L_1406[]="can't relocate value at %x,%d";
static const char L_1407[]="%s_from_thumb";
static const char L_1408[]="can't relocate value at %x,%d";
static const char L_1409[]="can't relocate value at %x,%d";
static const char L_1410[]="FIXME: handle reloc type %x at %x [%p] to %x\n";
#endif
        ...
        case R_ARM_THM_JUMP24:
            {
                ...
                if (!to_thumb && !to_plt && !is_call) {
                    ...
                    snprintf(buf, sizeof(buf), L_1407, name);
