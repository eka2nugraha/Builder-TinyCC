#ifndef dL_3201
#define dL_3201
static const char L_3201[]=".assembly extern mscorlib\n{\n.ver 1:0:2411:0\n}\n\n";
static const char L_3202[]=" %s\n";
static const char L_3203[]=" %s %d\n";
static const char L_3204[]=" %s 0x%x\n";
static const char L_3205[]="unsigned ";
static const char L_3206[]="void";
static const char L_3207[]="bool";
static const char L_3208[]="int8";
static const char L_3209[]="int16";
static const char L_3210[]="int32";
static const char L_3211[]="int64";
static const char L_3212[]="float32";
static const char L_3213[]="float64";
static const char L_3214[]="structures not handled yet";
static const char L_3215[]="(";
static const char L_3216[]=", ";
static const char L_3217[]=")";
static const char L_3218[]="*";
static const char L_3219[]=" ";
static const char L_3220[]=" %s L%d\n";
static const char L_3221[]="L%d:\n";
static const char L_3222[]="structures passed as value not handled yet";
static const char L_3223[]="xxx";
static const char L_3224[]=" call %s\n";
static const char L_3225[]=" calli %s\n";
static const char L_3226[]=".method static %s il managed\n";
static const char L_3227[]="{\n";
static const char L_3228[]=" .maxstack %d\n";
static const char L_3229[]=" .locals (int32, int32, int32, int32, int32, int32, int32, int32)\n";
static const char L_3230[]="main";
static const char L_3231[]=" .entrypoint\n";
static const char L_3232[]="}\n\n";
#endif
/*
...
{
    out_op1(op);
    fprintf(il_outfile, L_3202, il_opcodes_str[op]);
}
...
static void out_opb(int op, int c)
{
    out_op1(op);
    out_byte(c);
    fprintf(il_outfile, L_3203, il_opcodes_str[op], c);
}
...
static void out_opi(int op, int c)
{
    out_op1(op);
    out_le32(c);
    fprintf(il_outfile, L_3204, il_opcodes_str[op], c);
}
                           ...
                           int t, const char *varstr)
{
    ...
    case VT_FUNC:
        ...
        while (sa != NULL) {
            ...
            sa = sa->next;
            if (sa)
                pstrcat(buf, buf_size, L_3216);
        }
        pstrcat(buf, buf_size, L_3217);
        goto no_var;
    case VT_PTR:
        s = sym_find((unsigned)t >> VT_STRUCT_SHIFT);
        pstrcpy(buf1, sizeof(buf1), L_3218);
        if (varstr)
...
static int out_opj(int op, int c)
{
    ...
    fprintf(il_outfile, L_3220, il_opcodes_str[op], c);
    return c;
}

void gsym(int t)
{
    fprintf(il_outfile, L_3221, t);
}
...
void gfunc_call(GFuncContext *c)
{
    ...
    if ((vtop->r & (VT_VALMASK | VT_LVAL)) == VT_CONST) {
        ...
        il_type_to_str(buf, sizeof(buf), vtop->t, L_3223);
        fprintf(il_outfile, L_3224, buf);
    } else {
        /* indirect call */
        gv(RC_INT);
        il_type_to_str(buf, sizeof(buf), vtop->t, NULL);
        fprintf(il_outfile, L_3225, buf);
    }
    vtop--;
}
...
void gfunc_prolog(int t)
{
    ...
    fprintf(il_outfile, L_3226, buf);
    fprintf(il_outfile, L_3227);
    /* XXX: cannot do better now */
    fprintf(il_outfile, L_3228, NB_REGS);
    fprintf(il_outfile, L_3229);
    
    if (!strcmp(funcname, L_3230))
        fprintf(il_outfile, L_3231);
