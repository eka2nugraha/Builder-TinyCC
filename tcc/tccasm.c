#ifndef dL_4001
#define dL_4001
static const char L_4001[]="L..%u";
static const char L_4002[]="L.123";
static const char L_4003[]="L.%s";
static const char L_4004[]="local label '%d' not found backward";
static const char L_4005[]="invalid number syntax";
static const char L_4006[]="invalid operation with label";
static const char L_4007[]="bad expression syntax [%s]";
static const char L_4008[]="invalid operation with label";
static const char L_4009[]="division by zero";
static const char L_4010[]="invalid operation with label";
static const char L_4011[]="invalid operation with label";
static const char L_4012[]="invalid operation with label";
static const char L_4013[]="constant";
static const char L_4014[]="define";
static const char L_4015[]="assembler label '%s' already defined";
static const char L_4016[]=".popsection without .pushsection";
static const char L_4017[]="invalid p2align, must be between 0 and 30";
static const char L_4018[]="alignment must be a positive power of two";
static const char L_4019[]="64 bit constant";
static const char L_4020[]="constant";
static const char L_4021[]="repeat < 0; .fill ignored";
static const char L_4022[]="size < 0; .fill ignored";
static const char L_4023[]="we at end of file, .endr not found";
static const char L_4024[]="constant or same-section symbol";
static const char L_4025[]="attempt to .org backwards";
static const char L_4026[]="string constant";
static const char L_4027[]="%s%d";
static const char L_4028[]="%s";
static const char L_4029[]="ignoring .file %s";
static const char L_4030[]="ignoring .ident %s";
static const char L_4031[]="label not found: %s";
static const char L_4032[]="ignoring .size %s,*";
static const char L_4033[]="function";
static const char L_4034[]="STT_FUNC";
static const char L_4035[]="change type of '%s' from 0x%x to '%s' ignored";
static const char L_4036[]="string constant";
static const char L_4037[]="no previous section referenced";
static const char L_4038[]="unknown assembler directive '.%s'";
static const char L_4039[]="':'";
static const char L_4040[]="end of line";
static const char L_4041[]=":asm:";
static const char L_4042[]="@PLT";
static const char L_4043[]="invalid operand reference after %%";
static const char L_4044[]="too many asm operands";
static const char L_4045[]="identifier";
static const char L_4046[]="string constant";
static const char L_4047[]="string constant";
static const char L_4048[]="';'";
static const char L_4049[]="asm: \"%s\"\n";
static const char L_4050[]="subst_asm: \"%s\"\n";
static const char L_4051[]="';'";
static const char L_4052[]="asm_global: \"%s\"\n";
#endif
/*
...
ST_FUNC int asm_get_local_label_name(TCCState *s1, unsigned int n)
{
    ...
    snprintf(buf, sizeof(buf), L_4001, n);
...
/* Return a symbol we can use inside the assembler, having name NAME.
   ...
   either not accessible by name (like L_4002), or its type information
...
static Sym* asm_section_sym(TCCState *s1, Section *sec)
{
    ...
    int label = tok_alloc(buf,
        snprintf(buf, sizeof buf, L_4003, sec->name)
        )->tok;
...
static void asm_expr_unary(TCCState *s1, ExprValue *pe)
{
    ...
    default:
		...
		pe->pcrel = 0;
            ...
            tcc_error(L_4007, get_tok_str(tok, &tokc));
        }
        break;
    }
}
                           ...
                           int sh_num, int value)
{
	...
	/* A VT_EXTERN symbol, even if it has a section is considered
	   overridable.  This is how we L_4014 .set targets.  Real
...
static void asm_parse_directive(TCCState *s1, int global)
{
	...
	{ 
		...
		next();
            ...
            if (n)
                sprintf(sname, L_4027, get_tok_str(tok1, NULL), n);
            else
                sprintf(sname, L_4028, get_tok_str(tok1, NULL));
    ...
    case TOK_ASMDIR_size:
        { 
            ...
            if (!sym) {
                tcc_error(L_4031, get_tok_str(tok, NULL));
            }

            /* XXX .size name,label2-label1 */
            if (s1->warn_unsupported)
                tcc_warning(L_4032, get_tok_str(tok, NULL));
    ...
    case TOK_ASMDIR_type:
        { 
            ...
            if (!strcmp(newtype, L_4033) || !strcmp(newtype, L_4034)) {
...
#endif
    default:
        tcc_error(L_4038, get_tok_str(tok, NULL));
        break;
    }
}
                               ...
                               CString *out_str, CString *in_str)
{
    ...
    for(;;) {
		...
		*str == 'q' ||
		/* P in GCC would add L_4042 to symbol refs in PIC mode,
