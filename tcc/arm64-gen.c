#ifndef dL_1601
#define dL_1601
static const char L_1601[]="branch out of range";
static const char L_1602[]="load(%x, (%x, %x, %llx))\n";
static const char L_1603[]="store(%x, (%x, %x, %llx))\n";
static const char L_1604[]="arm64_pcs return: ";
static const char L_1605[]="arm64_pcs arg %d: ";
static const char L_1606[]="void\n";
static const char L_1607[]="X8 pointer\n";
static const char L_1608[]="X%lu%s\n";
static const char L_1609[]=" pointer";
static const char L_1610[]="";
static const char L_1611[]="V%lu\n";
static const char L_1612[]="stack %lu%s\n";
static const char L_1613[]=" pointer";
static const char L_1614[]="";
#endif
/*
...
ST_FUNC void load(int r, SValue *sv)
{
    ...
    printf(L_1602, r, svtt, sv->r, (long long)svcul);
    assert(0);
}
...
ST_FUNC void store(int r, SValue *sv)
{
    ...
    printf(L_1603, r, svtt, sv->r, (long long)svcul);
    assert(0);
}
    ...
    if (0) {
        ...
        for (i = 0; i <= n; i++) {
            ...
            if (a[i] == (unsigned long)-1)
                ...
                printf(L_1608, a[i] / 2, a[i] & 1 ? L_1609 : L_1610);
            else if (a[i] < 32)
                printf(L_1611, a[i] / 2 - 8);
            else
                printf(L_1612,
                       (a[i] - 32) & ~1, a[i] & 1 ? L_1613 : L_1614);
        }
    }
