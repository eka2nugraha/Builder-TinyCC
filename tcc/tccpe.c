#ifndef dL_5001
#define dL_5001
static const char L_5001[]="__imp_";
static const char L_5002[]="_imp__";
static const char L_5003[]="wb";
static const char L_5004[]="could not write '%s': %s";
static const char L_5005[]="-------------------------------\n  virt   file   size  section\n";
static const char L_5006[]="%6x %6x %6x  %s\n";
static const char L_5007[]="-------------------------------\n";
static const char L_5008[]="<- %s (%u bytes)\n";
static const char L_5009[]="";
static const char L_5010[]="can't build symbol '%s'";
static const char L_5011[]="export: %s\n";
static const char L_5012[]="stdcall: %s\n";
static const char L_5013[]=".def";
static const char L_5014[]="wb";
static const char L_5015[]="could not create '%s': %s";
static const char L_5016[]="LIBRARY %s\n\nEXPORTS\n";
static const char L_5017[]="<- %s (%d symbol%s)\n";
static const char L_5018[]="s";
static const char L_5019[]="%s\n";
static const char L_5020[]=".rsrc";
static const char L_5021[]=".iedat";
static const char L_5022[]=".pdata";
static const char L_5023[]=".reloc";
static const char L_5024[]=".stab";
static const char L_5025[]=".reloc";
static const char L_5026[]="section %-16s %-10s %5x %s,%s,%s\n";
static const char L_5027[]="progbits";
static const char L_5028[]="nobits";
static const char L_5029[]="symtab";
static const char L_5030[]="strtab";
static const char L_5031[]="rel";
static const char L_5032[]="???";
static const char L_5033[]="alloc";
static const char L_5034[]="";
static const char L_5035[]="write";
static const char L_5036[]="";
static const char L_5037[]="exec";
static const char L_5038[]="";
static const char L_5039[]="IAT.%s";
static const char L_5040[]="undefined symbol '%s'%s";
static const char L_5041[]=", missing __declspec(dllimport)?";
static const char L_5042[]="";
static const char L_5043[]="section  \"%s\"";
static const char L_5044[]="\nlink     \"%s\"";
static const char L_5045[]="\nreloc    \"%s\"";
static const char L_5046[]="\nv_addr   %08X";
static const char L_5047[]="\ncontents %08X";
static const char L_5048[]="\n\n";
static const char L_5049[]="%-8s";
static const char L_5050[]="offset";
static const char L_5051[]=" %02x";
static const char L_5052[]="name";
static const char L_5053[]="value";
static const char L_5054[]="size";
static const char L_5055[]="bind";
static const char L_5056[]="type";
static const char L_5057[]="other";
static const char L_5058[]="shndx";
static const char L_5059[]="offs";
static const char L_5060[]="type";
static const char L_5061[]="symb";
static const char L_5062[]="%6s";
static const char L_5063[]="  symbol";
static const char L_5064[]="\n";
static const char L_5065[]="-";
static const char L_5066[]="\n";
static const char L_5067[]="%08X";
static const char L_5068[]=" %02X";
static const char L_5069[]="   ";
static const char L_5070[]="  %04X  %04X  %04X   %02X    %02X    %02X   %04X  \"%s\"";
static const char L_5071[]="  %04X   %02X   %04X  \"%s\"";
static const char L_5072[]="   ";
static const char L_5073[]="%c";
static const char L_5074[]="\n";
static const char L_5075[]="\n\n";
static const char L_5076[]="w";
static const char L_5077[]=".rsrc";
static const char L_5078[]=".rsrc";
static const char L_5079[]=".rsrc";
static const char L_5080[]="rb";
static const char L_5081[]="LIBRARY";
static const char L_5082[]="EXPORTS";
static const char L_5083[]=".def";
static const char L_5084[]="MZ\220";
static const char L_5085[]=".pdata";
static const char L_5086[]=".uw_base";
#ifdef TCC_TARGET_X86_64
static const char L_5087[]="WinMain";
#else
static const char L_5087[]="W_inMain@16";
#endif
#ifdef TCC_TARGET_X86_64
static const char L_5088[]="wWinMain";
#else
static const char L_5088[]="w_WinMain@16";
#endif
static const char L_5089[]="wmain";
static const char L_5090[]="__runwwinmain";
static const char L_5091[]="__runwinmain";
static const char L_5092[]="__runwmain";
static const char L_5093[]="__runmain";
#ifdef TCC_TARGET_X86_64
static const char L_5094[]="__dllstart";
#else
static const char L_5094[]="___dllstart@12";
#endif
static const char L_5095[]="__wwinstart";
static const char L_5096[]="__winstart";
static const char L_5097[]="__wstart";
static const char L_5098[]="__start";
static const char L_5099[]="msvcrt";
static const char L_5100[]="kernel32";
static const char L_5101[]="";
static const char L_5102[]="user32";
static const char L_5103[]="gdi32";
static const char L_5104[]=".pdata";
static const char L_5105[]="tcc.log";
#endif
/*
...
static int pe_find_import(TCCState * s1, ElfW(Sym) *sym)
{
    ...
    do {
	    ...
	    } else if (0 == memcmp(s, L_5001, 6)) { /* mingw 2.0 */
	        strcpy(buffer, s + 6), a = 1;
	    } else if (0 == memcmp(s, L_5002, 6)) { /* mingw 3.7 */
	        strcpy(buffer, s + 6), a = 1;
	    } else {
	        continue;
	    }
...
#define CHARACTERISTICS_DLL 0x230F
    ...
    op = fopen(pe->filename, L_5003);
    if (NULL == op) {
        tcc_error_noabort(L_5004, pe->filename, strerror(errno));
        return -1;
    }
    ...
    if (2 == pe->s1->verbose)
        printf(L_5007);
    if (pe->s1->verbose)
        printf(L_5008, pe->filename, (unsigned)file_offset);
...
static void pe_build_exports(struct pe_info *pe)
{
    ...
    strcpy(tcc_fileextension(buf), L_5013);
    op = fopen(buf, L_5014);
    if (NULL == op) {
        tcc_error_noabort(L_5015, buf, strerror(errno));
    } else {
        fprintf(op, L_5016, dllname);
        if (pe->s1->verbose)
            printf(L_5017, buf, sym_count, &L_5018[sym_count < 2]);
    }
#endif
...
static int pe_section_class(Section *s)
{
    ...
    if (flags & SHF_ALLOC) {
        if (type == SHT_PROGBITS) {
            ...
            if (flags & SHF_WRITE)
                return sec_data;
            if (0 == strcmp(name, L_5020))
                return sec_rsrc;
            if (0 == strcmp(name, L_5021))
                return sec_idata;
            if (0 == strcmp(name, L_5022))
                return sec_pdata;
            return sec_other;
        ...
        if (0 == strcmp(name, L_5023))
            return sec_reloc;
        if (0 == strncmp(name, L_5024, 5)) /* .stab and .stabstr */
            return sec_stab;
    }
    return -1;
}
...
static int pe_assign_addresses (struct pe_info *pe)
{
    ...
    if (PE_DLL == pe->type)
        pe->reloc = new_section(pe->s1, L_5025, SHT_PROGBITS, 0);
    ...
    for (i = 1; i < pe->s1->nb_sections; ++i) {
        ...
        printf(L_5026,
            s->name,
            type == SHT_PROGBITS ? L_5027 :
            type == SHT_NOBITS ? L_5028 :
            type == SHT_SYMTAB ? L_5029 :
            type == SHT_STRTAB ? L_5030 :
            type == SHT_RELX ? L_5031 : L_5032,
            s->data_offset,
            flags & SHF_ALLOC ? L_5033 : L_5034,
            flags & SHF_WRITE ? L_5035 : L_5036,
            flags & SHF_EXECINSTR ? L_5037 : L_5038
            );
    }
    pe->s1->verbose = 2;
#endif
    ...
    for (sym_index = 1; sym_index < sym_end; ++sym_index) {
        ...
        not_found:
            if (ELFW(ST_BIND)(sym->st_info) == STB_WEAK)
                ...
                continue;
            tcc_error_noabort(L_5040, name,
                imp_sym < 0 ? L_5041:L_5042);
            ret = -1;
...
static void pe_print_section(FILE * f, Section * s)
{
    ...
    fprintf(f, L_5043, s->name);
    if (s->link)
        fprintf(f, L_5044, s->link->name);
    if (s->reloc)
        fprintf(f, L_5045, s->reloc->name);
    fprintf(f, L_5046, (unsigned)s->sh_addr);
    fprintf(f, L_5047, (unsigned)l);
    fprintf(f, L_5048);
...
static int pe_load_res(TCCState *s1, int fd)
{
    ...
    if (hdr.filehdr.Machine != IMAGE_FILE_MACHINE
        ...
        || strcmp((char*)hdr.sectionhdr.Name, L_5077) != 0)
        goto quit;

    rsrc_section = new_section(s1, L_5078, SHT_PROGBITS, SHF_ALLOC);
    ...
    sym_index = put_elf_sym(symtab_section, 0, 0, 0, 0, rsrc_section->sh_num, L_5079);
...
ST_FUNC int pe_load_file(struct TCCState *s1, const char *filename, int fd)
{
    int ret = -1;
    char buf[10];
    if (0 == strcmp(tcc_fileextension(filename), L_5083))
        ret = pe_load_def(s1, fd);
    else if (pe_load_res(s1, fd) == 0)
        ret = 0;
    else if (read_mem(fd, 0, buf, 4) && 0 == memcmp(buf, L_5084, 4))
...
{
    if (NULL == s1->uw_pdata) {
        s1->uw_pdata = find_section(tcc_state, L_5085);
        s1->uw_pdata->sh_addralign = 4;
    }
    if (0 == s1->uw_sym)
        s1->uw_sym = put_elf_sym(symtab_section, 0, 0, 0, 0, text_section->sh_num, L_5086);
    if (0 == s1->uw_offs) {
...
static void pe_add_runtime(TCCState *s1, struct pe_info *pe)
{
    ...
    if (find_elf_sym(symtab_section, L_5087))
        pe_type = PE_GUI;
    else
    if (find_elf_sym(symtab_section, L_5088)) {
        pe_type = PE_GUI;
    ...
    if (TCC_OUTPUT_DLL == s1->output_type) {
        ...
        pe_type = PE_EXE;
        if (find_elf_sym(symtab_section, L_5089))
            unicode_entry = PE_EXE;
    }

    start_symbol =
        TCC_OUTPUT_MEMORY == s1->output_type
        ? PE_GUI == pe_type ? (unicode_entry ? L_5090 : L_5091)
            : (unicode_entry ? L_5092 : L_5093)
        : PE_DLL == pe_type ? L_5094
            : PE_GUI == pe_type ? (unicode_entry ? L_5095: L_5096)
                : (unicode_entry ? L_5097 : L_5098)
        ;
    ...
    if (0 == s1->nostdlib) {
        static const char *libs[] = {
            TCC_LIBTCC1, L_5099, L_5100, L_5101, L_5102, L_5103, NULL
        };
        const char **pp, *p;
...
#ifdef TCC_TARGET_X86_64
        s1->uw_pdata = find_section(s1, L_5104);
#endif
#endif
    }
