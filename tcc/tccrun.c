#ifndef dL_5401
#define dL_5401
static const char L_5401[]="/tmp/.tccrunXXXXXX";
static const char L_5402[]="tccrun: could not map memory";
static const char L_5403[]="main";
static const char L_5404[]="__bound_error_msg";
static const char L_5405[]="__bound_init";
static const char L_5406[]="__bound_exit";
static const char L_5407[]="__bound_new_region";
static const char L_5408[]="__bound_delete_region";
static const char L_5409[]="%-16s +%02lx %p %04x\n";
static const char L_5410[]="mprotect failed: did you mean to configure --with-selinux?";
static const char L_5411[]="%s %p ???\n";
static const char L_5412[]="%s:%d: ";
static const char L_5413[]="%s %p";
static const char L_5414[]=" %s()";
static const char L_5415[]=" (included from ";
static const char L_5416[]="%s";
static const char L_5417[]=", ";
static const char L_5418[]=")";
static const char L_5419[]="\n";
static const char L_5420[]="Runtime error: ";
static const char L_5421[]="\n";
static const char L_5422[]="by";
static const char L_5423[]="at";
static const char L_5424[]="division by zero";
static const char L_5425[]="floating point exception";
static const char L_5426[]="dereferencing invalid pointer";
static const char L_5427[]="illegal instruction";
static const char L_5428[]="abort() called";
static const char L_5429[]="caught signal %d";
static const char L_5430[]="access violation";
static const char L_5431[]="stack overflow";
static const char L_5432[]="division by zero";
static const char L_5433[]="exception caught";
static const char L_5434[]="error";
#endif
/*
...
LIBTCCAPI int tcc_run(TCCState *s1, int argc, char **argv)
{
    ...
    if (s1->do_bounds_check) {
        ...
        /* set error function */
        rt_bound_error_msg = tcc_get_symbol_err(s1, L_5404);
        /* XXX: use .init section so that it also work in binary ? */
        bound_init = tcc_get_symbol_err(s1, L_5405);
        bound_exit = tcc_get_symbol_err(s1, L_5406);
        bound_new_region = tcc_get_symbol_err(s1, L_5407);
        bound_delete_region = tcc_get_symbol_err(s1, L_5408);
...
no_stabs:
    ...
    fprintf(stderr, L_5411, msg, (void*)wanted_pc);
    fflush(stderr);
    return 0;
 found:
    i = incl_index;
    if (i > 0)
        fprintf(stderr, L_5412, incl_files[--i], last_line_num);
    fprintf(stderr, L_5413, msg, (void*)wanted_pc);
    if (last_func_name[0] != '\0')
        fprintf(stderr, L_5414, last_func_name);
    if (--i >= 0) {
        fprintf(stderr, L_5415);
        for (;;) {
            fprintf(stderr, L_5416, incl_files[i]);
            if (--i < 0)
                break;
            fprintf(stderr, L_5417);
        }
        fprintf(stderr, L_5418);
    }
    fprintf(stderr, L_5419);
    fflush(stderr);
    return func_addr;
}
...
static void rt_error(ucontext_t *uc, const char *fmt, ...)
{
    ...
    fprintf(stderr, L_5420);
    va_start(ap, fmt);
    vfprintf(stderr, fmt, ap);
    va_end(ap);
    fprintf(stderr, L_5421);

    for(i=0;i<rt_num_callers;i++) {
        if (rt_get_caller_pc(&pc, uc, i) < 0)
            break;
        pc = rt_printline(pc, i ? L_5422 : L_5423);
