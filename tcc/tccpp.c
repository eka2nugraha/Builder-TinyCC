#ifndef dL_5201
#define dL_5201
static const char L_5201[]="-=\255*=\252/=\257%=\245&=\246^=\336|=\374->\313..\250##\266";
static const char L_5202[]="'%c' expected (got \"%s\")";
static const char L_5203[]="%s expected";
static const char L_5204[]="limit=%5d, size=%5g MB, nb_peak=%6d, nb_total=%8d, nb_missed=%6d, usage=%5.1f%%\n";
static const char L_5205[]="TAL_DEBUG: memory leak %d chunk(s) (limit= %d)\n";
static const char L_5206[]="%s:%d: chunk of %d bytes leaked\n";
static const char L_5207[]="%s:%d: TAL_DEBUG: double frees chunk from\n";
static const char L_5208[]="%s:%d: %d bytes\n";
static const char L_5209[]="memory full (symbols)";
static const char L_5210[]="%u";
static const char L_5211[]="%llu";
static const char L_5212[]="<float>";
static const char L_5213[]="<double>";
static const char L_5214[]="<long double>";
static const char L_5215[]="<linenumber>";
static const char L_5216[]="...";
static const char L_5217[]="<<=";
static const char L_5218[]=">>=";
static const char L_5219[]="<eof>";
static const char L_5220[]="<%02x>";
static const char L_5221[]="L.%u";
static const char L_5222[]="stray '\\' in program";
static const char L_5223[]="stray '\\' in program";
static const char L_5224[]="unexpected end of file in comment";
static const char L_5225[]="unexpected end of file in comment";
static const char L_5226[]="missing terminating %c character";
static const char L_5227[]="'\n' after '\r'";
static const char L_5228[]="#endif";
static const char L_5229[]="%s redefined";
static const char L_5230[]="label '%s' declared but not used";
static const char L_5231[]="label '%s' used but not defined";
static const char L_5232[]="test_";
static const char L_5233[]="\n[%s]\n";
static const char L_5234[]="identifier";
static const char L_5235[]="')'";
static const char L_5236[]="invalid macro name '%s'";
static const char L_5237[]="bad macro parameter list";
static const char L_5238[]="'##' cannot appear at either end of macro";
static const char L_5239[]="adding cached '%s'\n";
static const char L_5240[]="unbalanced #pragma pop_macro";
static const char L_5241[]="out of pack stack";
static const char L_5242[]="#pragma %s is ignored";
static const char L_5243[]="malformed #pragma directive";
static const char L_5244[]="'#include' expects \"FILENAME\" or <FILENAME>";
static const char L_5245[]="#include recursion too deep";
static const char L_5246[]="/";
static const char L_5247[]="%s: skipping cached %s\n";
static const char L_5248[]="%s: including %s\n";
static const char L_5249[]="include file '%s' not found";
static const char L_5250[]="invalid argument for '#if%sdef'";
static const char L_5251[]="n";
static const char L_5252[]="";
static const char L_5253[]="#ifndef %s\n";
static const char L_5254[]="memory full (ifdef)";
static const char L_5255[]="#else without matching #if";
static const char L_5256[]="#else after #else";
static const char L_5257[]="#elif without matching #if";
static const char L_5258[]="#elif after #else";
static const char L_5259[]="#endif without matching #if";
static const char L_5260[]="wrong #line format";
static const char L_5261[]="#error %s";
static const char L_5262[]="#warning %s";
static const char L_5263[]="Ignoring unknown preprocessing directive #%s";
static const char L_5264[]="unknown escape sequence: \'\\%c\'";
static const char L_5265[]="unknown escape sequence: \'\\x%x\'";
static const char L_5266[]="ill-formed UTF-8 subsequence starting with: \'\\x%x\'";
static const char L_5267[]="empty character constant";
static const char L_5268[]="multi-character character constant";
static const char L_5269[]="number too long";
static const char L_5270[]="invalid digit";
static const char L_5271[]="exponent";
static const char L_5272[]="exponent digits";
static const char L_5273[]="exponent digits";
static const char L_5274[]="invalid digit";
static const char L_5275[]="three 'l's in integer constant";
static const char L_5276[]="incorrect integer suffix: %s";
static const char L_5277[]="two 'u's in integer constant";
static const char L_5278[]="integer constant overflow";
static const char L_5279[]="invalid number\n";
static const char L_5280[]="missing #endif";
static const char L_5281[]="#endif %s\n";
static const char L_5282[]="unrecognized character \\x%02x";
static const char L_5283[]="token = %d %s\n";
static const char L_5284[]="\nstringize: <%s>\n";
static const char L_5285[]="macro parameter after '#'";
static const char L_5286[]=":paste:";
static const char L_5287[]="pasting \"%.*s\" and \"%s\" does not give a valid preprocessing token";
static const char L_5288[]="%d";
static const char L_5289[]="%s %2d %d";
static const char L_5290[]="%02d:%02d:%02d";
static const char L_5291[]="macro '%s' used with too many args";
static const char L_5292[]=")";
static const char L_5293[]=",";
static const char L_5294[]="macro '%s' used with too few args";
static const char L_5295[]="stray '\\' in program";
static const char L_5296[]="\"";
static const char L_5297[]="\"";
static const char L_5298[]="__BASE_FILE__";
static const char L_5299[]="#include \"";
static const char L_5300[]="\"\n";
static const char L_5301[]="<command line>";
static const char L_5302[]="__ASSEMBLER__";
static const char L_5303[]="%s";
static const char L_5304[]=" %s";
static const char L_5305[]="\n";
static const char L_5306[]="\n";
static const char L_5307[]="#line %d \"%s\"\n";
static const char L_5308[]="# %d \"%s\"%s\n";
static const char L_5309[]=" 1";
static const char L_5310[]=" 2";
static const char L_5311[]="";
static const char L_5312[]="#define %s";
static const char L_5313[]="(";
static const char L_5314[]="%s";
static const char L_5315[]=",";
static const char L_5316[]=")";
static const char L_5317[]="";
static const char L_5318[]="#undef %s\n";
static const char L_5319[]="#pragma push_macro(\"%s\")\n";
static const char L_5320[]="#pragma pop_macro(\"%s\")\n";
#endif
/*
 *  TCC - Tiny C Compiler
 * 
...
{
    if (tok != c)
        tcc_error(L_5202, c, get_tok_str(tok, &tokc));
    next();
}

ST_FUNC void expect(const char *msg)
{
    tcc_error(L_5203, msg);
}
...
tail_call:
    ...
    if (al->nb_allocs > 0) {
        uint8_t *p;
        fprintf(stderr, L_5205,
                al->nb_allocs, al->limit);
        p = al->buffer;
        while (p < al->p) {
            tal_header_t *header = (tal_header_t *)p;
            if (header->line_num > 0) {
                fprintf(stderr, L_5206,
...
tail_call:
    if (al->buffer <= (uint8_t *)p && (uint8_t *)p < al->buffer + al->size) {
        ...
        if (header->line_num < 0) {
            fprintf(stderr, L_5207,
                    file, line);
            fprintf(stderr, L_5208,
...
ST_FUNC const char *get_tok_str(int v, CValue *cv)
{
...
#ifdef _WIN32
        sprintf(p, L_5210, (unsigned)cv->i);
#else
        sprintf(p, L_5211, (unsigned long long)cv->i);
#endif
        break;
    case TOK_LCHAR:
    ...
    case TOK_CFLOAT:
        cstr_cat(&cstr_buf, L_5212, 0);
        break;
    case TOK_CDOUBLE:
	cstr_cat(&cstr_buf, L_5213, 0);
	break;
    case TOK_CLDOUBLE:
	cstr_cat(&cstr_buf, L_5214, 0);
	break;
    case TOK_LINENUM:
	cstr_cat(&cstr_buf, L_5215, 0);
	break;
    ...
    case TOK_GT:
        ...
        goto addv;
    case TOK_DOTS:
        return strcpy(p, L_5216);
    case TOK_A_SHL:
        return strcpy(p, L_5217);
    case TOK_A_SAR:
        return strcpy(p, L_5218);
    case TOK_EOF:
        return strcpy(p, L_5219);
    default:
        if (v < TOK_IDENT) {
        ...
        if (v >= 127) {
            sprintf(cstr_buf.data, L_5220, v);
            return cstr_buf.data;
        }
        addv:
            *p++ = v;
            *p = '\0';
            ...
            sprintf(p, L_5221, v - SYM_FIRST_ANOM);
        } else {
            /* should never happen */
            return NULL;
        }
...
ST_INLN void define_push(int v, int macro_type, int *str, Sym *first_arg)
{
	...
	tcc_warning(L_5229, get_tok_str(v, NULL));
}
...
ST_FUNC void label_pop(Sym **ptop, Sym *slast, int keep)
{
    ...
    for(s = *ptop; s != slast; s = s1) {
        ...
        if (s->r == LABEL_DECLARED) {
            tcc_warning(L_5230, get_tok_str(s->v, NULL));
...
static void maybe_run_test(TCCState *s)
{
    ...
    if (0 != memcmp(p, L_5232, 5))
        return;
    if (0 != --s->run_test)
        return;
    fprintf(s->ppfp, &L_5233[!(s->dflag & 32)], p), fflush(s->ppfp);
...
ST_FUNC void parse_define(void)
{
    ...
    if (v < TOK_IDENT || v == TOK_DEFINED)
        tcc_error(L_5236, get_tok_str(tok, &tokc));
...
static void pragma_parse(TCCState *s1)
{
    ...
    if (tok == TOK_push_macro || tok == TOK_pop_macro) {
        ...
        tcc_warning(L_5242, get_tok_str(tok, &tokc));
    }
    return;
        ...
        *s1->include_stack_ptr = file;
        ...
        for (; i < n; ++i) {
            ...
            if (i == 0) {
                ...
                pstrcat(buf1, sizeof(buf1), L_5246);
            }
...
#ifdef INC_DEBUG
                printf(L_5247, file->filename, buf1);
#endif
                goto include_done;
            }
...
#ifdef INC_DEBUG
            printf(L_5248, file->prev->filename, file->filename);
#endif
            /* update target deps */
...
include_done:
    ...
    do_ifdef:
        next_nomacro();
        if (tok < TOK_IDENT)
            tcc_error(L_5250, c ? L_5251 : L_5252);
        if (is_bof) {
            if (c) {
#ifdef INC_DEBUG
                printf(L_5253, get_tok_str(tok, NULL));
#endif
    ...
    case TOK_WARNING:
        ...
        *q = '\0';
        if (c == TOK_ERROR)
            tcc_error(L_5261, buf);
        else
            tcc_warning(L_5262, buf);
        break;
    case TOK_PRAGMA:
        pragma_parse(s1);
        break;
    ...
    default:
        ...
        if (tok == '!' && is_bof)
            ...
            goto ignore;
        tcc_warning(L_5263, get_tok_str(tok, &tokc));
    ignore:
...
static void parse_escape_string(CString *outstr, const uint8_t *buf, int is_long)
{
    ...
    for(;;) {
        ...
        if (c == '\\') {
            ...
            invalid_escape:
                if (c >= '!' && c <= '~')
                    tcc_warning(L_5264, c);
                else
                    tcc_warning(L_5265, c);
                break;
            }
...
#ifdef INC_DEBUG
                    printf(L_5281, get_tok_str(file->ifndef_macro_saved, NULL));
#endif
...
keep_tok_flags:
    file->buf_ptr = p;
#if defined(PARSE_DEBUG)
    printf(L_5283, tok, get_tok_str(tok, &tokc));
#endif
}
...
static int paste_tokens(int t1, CValue *v1, int t2, CValue *v2)
{
    ...
    tcc_open_bf(tcc_state, L_5286, cstr.size);
    ...
    for (;;) {
        ...
        if (is_space(tok))
            continue;
        tcc_warning(L_5287, n, cstr.data, (char*)cstr.data + n);
        ret = 0;
        break;
    }
    tcc_close();
    ...
    Sym *s)
{
    ...
    if (tok == TOK___LINE__ || tok == TOK___COUNTER__) {
        ...
        snprintf(buf, sizeof(buf), L_5288, t);
        cstrval = buf;
        t1 = TOK_PPNUM;
        goto add_cstr1;
        ...
        tm = localtime(&ti);
        if (tok == TOK___DATE__) {
            snprintf(buf, sizeof(buf), L_5289, 
                     ab_month_name[tm->tm_mon], tm->tm_mday, tm->tm_year + 1900);
        } else {
            snprintf(buf, sizeof(buf), L_5290, 
...
ST_FUNC void preprocess_start(TCCState *s1, int is_asm)
{
    ...
    cstr_new(&cstr);
    cstr_cat(&cstr, L_5296, -1);
    cstr_cat(&cstr, file->filename, -1);
    cstr_cat(&cstr, L_5297, 0);
    tcc_define_symbol(s1, L_5298, cstr.data);

    cstr_reset(&cstr);
    for (i = 0; i < s1->nb_cmd_include_files; i++) {
        cstr_cat(&cstr, L_5299, -1);
        cstr_cat(&cstr, s1->cmd_include_files[i], -1);
        cstr_cat(&cstr, L_5300, -1);
    }
    if (cstr.size) {
        *s1->include_stack_ptr++ = file;
	tcc_open_bf(s1, L_5301, cstr.size);
	memcpy(file->buffer, cstr.data, cstr.size);
    }
    cstr_free(&cstr);

    if (is_asm)
        tcc_define_symbol(s1, L_5302, NULL);
...
static void tok_print(const char *msg, const int *str)
{
    ...
    fp = tcc_state->ppfp;
    fprintf(fp, L_5303, msg);
    while (str) {
	TOK_GET(&t, &str, &cval);
	if (!t)
	    break;
	fprintf(fp, &L_5304[s], get_tok_str(t, &cval)), s = 1;
    }
    fprintf(fp, L_5305);
}
...
static void pp_line(TCCState *s1, BufferedFile *f, int level)
{
	...
	while (d > 0)
	    fputs(L_5306, s1->ppfp), --d;
    } else if (s1->Pflag == LINE_MACRO_OUTPUT_FORMAT_STD) {
	fprintf(s1->ppfp, L_5307, f->line_num, f->filename);
    } else {
	fprintf(s1->ppfp, L_5308, f->line_num, f->filename,
	    level > 0 ? L_5309 : level < 0 ? L_5310 : L_5311);
    }
...
static void define_print(TCCState *s1, int v)
{
    ...
    fp = s1->ppfp;
    fprintf(fp, L_5312, get_tok_str(v, NULL));
    if (s->type.t == MACRO_FUNC) {
        Sym *a = s->next;
        fprintf(fp,L_5313);
        if (a)
            for (;;) {
                fprintf(fp,L_5314, get_tok_str(a->v & ~SYM_FIELD, NULL));
                if (!(a = a->next))
                    break;
                fprintf(fp,L_5315);
            }
...
static void pp_debug_defines(TCCState *s1)
{
    ...
    if (t == TOK_DEFINE) {
        ...
        fprintf(fp, L_5318, vs);
    } else if (t == TOK_push_macro) {
        fprintf(fp, L_5319, vs);
    } else if (t == TOK_pop_macro) {
        fprintf(fp, L_5320, vs);
    }
    pp_debug_tok = 0;
}
