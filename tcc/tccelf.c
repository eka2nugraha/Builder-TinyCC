#ifndef dL_4401
#define dL_4401
static const char L_4401[]=".text";
static const char L_4402[]=".data";
static const char L_4403[]=".bss";
static const char L_4404[]=".common";
static const char L_4405[]=".symtab";
static const char L_4406[]=".strtab";
static const char L_4407[]=".hashtab";
static const char L_4408[]=".dynsymtab";
static const char L_4409[]=".dynstrtab";
static const char L_4410[]=".dynhashtab";
static const char L_4411[]=".bounds";
static const char L_4412[]=".lbounds";
static const char L_4413[]=".stab";
static const char L_4414[]=".stabstr";
static const char L_4415[]="";
static const char L_4416[]="";
static const char L_4417[]="";
static const char L_4418[]="%s not defined";
static const char L_4419[]="new_bind=%x new_shndx=%x new_vis=%x old_bind=%x old_shndx=%x old_vis=%x\n";
static const char L_4420[]="'%s' defined twice";
static const char L_4421[]="non-zero addend on REL architecture";
static const char L_4422[]="relocate_sym: %s -> 0x%lx\n";
static const char L_4423[]="_fp_hw";
static const char L_4424[]="undefined symbol '%s'";
static const char L_4425[]=".got";
static const char L_4426[]="_GLOBAL_OFFSET_TABLE_";
static const char L_4427[]=".plt";
static const char L_4428[]="@plt";
static const char L_4429[]="__%s_start";
static const char L_4430[]="__%s_end";
static const char L_4431[]="%s/%s";
static const char L_4432[]="__bounds_start";
static const char L_4433[]="__bound_init";
static const char L_4434[]=".init";
static const char L_4435[]="c";
static const char L_4436[]="crtn.o";
static const char L_4437[]="_etext";
static const char L_4438[]="_edata";
static const char L_4439[]="_end";
static const char L_4440[]=".preinit_array";
static const char L_4441[]=".init_array";
static const char L_4442[]=".fini_array";
static const char L_4443[]="__start_%s";
static const char L_4444[]="__stop_%s";
static const char L_4445[]="huh";
static const char L_4446[]="_fp_hw";
static const char L_4447[]="undefined symbol '%s'";
static const char L_4448[]="undefined dynamic symbol '%s'";
static const char L_4449[]=".rel.got";
static const char L_4450[]=".rel.bss";
static const char L_4451[]="_start";
static const char L_4452[]="could not write '%s'";
static const char L_4453[]="wb";
static const char L_4454[]="<- %s\n";
static const char L_4455[]="LD_SO";
static const char L_4456[]=".interp";
static const char L_4457[]=".dynsym";
static const char L_4458[]=".dynstr";
static const char L_4459[]=".hash";
static const char L_4460[]=".dynamic";
static const char L_4461[]=".shstrtab";
static const char L_4462[]="";
static const char L_4463[]="invalid object file";
static const char L_4464[]="object must contain only one symtab";
static const char L_4465[]=".stabstr";
static const char L_4466[]=".debug_";
static const char L_4467[]=".debug_";
static const char L_4468[]=".debug_";
static const char L_4469[]=".debug_";
static const char L_4470[]=".gnu.linkonce";
static const char L_4471[]=".gnu.linkonce";
static const char L_4472[]="invalid section type";
static const char L_4473[]=".stab";
static const char L_4474[]=".stabstr";
static const char L_4475[]="Invalid relocation entry [%2d] '%s' @ %.8x";
static const char L_4476[]="invalid archive";
static const char L_4477[]="/";
static const char L_4478[]="/SYM64/";
static const char L_4479[]="bad architecture";
static const char L_4480[]="referenced dll '%s' not found";
static const char L_4481[]="/.-_+=$:\\,~";
static const char L_4482[]="GROUP";
static const char L_4483[]="(";
static const char L_4484[]="unexpected end of file";
static const char L_4485[]="library name expected";
static const char L_4486[]="lib%s.a";
static const char L_4487[]="lib%s.so";
static const char L_4488[]="filename expected";
static const char L_4489[]="AS_NEEDED";
static const char L_4490[]="INPUT";
static const char L_4491[]="GROUP";
static const char L_4492[]="OUTPUT_FORMAT";
static const char L_4493[]="TARGET";
static const char L_4494[]="(";
static const char L_4495[]="unexpected end of file";
#endif
/*
...
ST_FUNC void tccelf_new(TCCState *s)
{
    ...
    text_section = new_section(s, L_4401, SHT_PROGBITS, SHF_ALLOC | SHF_EXECINSTR);
    data_section = new_section(s, L_4402, SHT_PROGBITS, SHF_ALLOC | SHF_WRITE);
    bss_section = new_section(s, L_4403, SHT_NOBITS, SHF_ALLOC | SHF_WRITE);
    common_section = new_section(s, L_4404, SHT_NOBITS, SHF_PRIVATE);
    common_section->sh_num = SHN_COMMON;

    /* symbols are always generated for linking stage */
    symtab_section = new_symtab(s, L_4405, SHT_SYMTAB, 0,
                                L_4406,
                                L_4407, SHF_PRIVATE);
    s->symtab = symtab_section;

    /* private symbol table for dynamic symbols */
    s->dynsymtab_section = new_symtab(s, L_4408, SHT_SYMTAB, SHF_PRIVATE|SHF_DYNSYM,
                                      L_4409,
                                      L_4410, SHF_PRIVATE);
    get_sym_attr(s, 0, 1);
}
...
ST_FUNC void tccelf_bounds_new(TCCState *s)
{
    ...
    bounds_section = new_section(s, L_4411,
                                 SHT_PROGBITS, SHF_ALLOC);
    lbounds_section = new_section(s, L_4412,
                                  SHT_PROGBITS, SHF_ALLOC);
}
#endif
...
{
    stab_section = new_section(s, L_4413, SHT_PROGBITS, 0);
    stab_section->sh_entsize = sizeof(Stab_Sym);
    stabstr_section = new_section(s, L_4414, SHT_STRTAB, 0);
    put_elf_str(stabstr_section, L_4415);
    stab_section->link = stabstr_section;
    /* put first entry */
    put_stabs(L_4416, 0, 0, 0, 0);
}
...
#ifdef DEBUG_RELOC
		    printf(L_4422, name, sym->st_value);
#endif
                    goto found;
                }
#endif
...
static void build_got(TCCState *s1)
{
    ...
    s1->got = new_section(s1, L_4425, SHT_PROGBITS, SHF_ALLOC | SHF_WRITE);
    s1->got->sh_entsize = 4;
    set_elf_sym(symtab_section, 0, 4, ELFW(ST_INFO)(STB_GLOBAL, STT_OBJECT),
                0, s1->got->sh_num, L_4426);
                                       ...
                                       int info, int sym_index)
{
    ...
    if (need_plt_entry) {
        if (!s1->plt) {
    	    s1->plt = new_section(s1, L_4427, SHT_PROGBITS,
...
static void add_init_array_defines(TCCState *s1, const char *section_name)
{
    ...
    snprintf(sym_start, sizeof(sym_start), L_4429, section_name + 1);
    snprintf(sym_end, sizeof(sym_end), L_4430, section_name + 1);
...
{
    char buf[1024];
    snprintf(buf, sizeof(buf), L_4431, s1->tcc_lib_path, filename);
...
ST_FUNC void tcc_add_bcheck(TCCState *s1)
{
    ...
    *ptr = 0;
    ...
    if (s1->output_type != TCC_OUTPUT_MEMORY) {
        ...
        Section *init_section = find_section(s1, L_4434);
...
static void tcc_add_linker_symbols(TCCState *s1)
{
    ...
    set_elf_sym(symtab_section,
                ...
                ELFW(ST_INFO)(STB_GLOBAL, STT_NOTYPE), 0,
                text_section->sh_num, L_4437);
    set_elf_sym(symtab_section,
                data_section->data_offset, 0,
                ELFW(ST_INFO)(STB_GLOBAL, STT_NOTYPE), 0,
                data_section->sh_num, L_4438);
    set_elf_sym(symtab_section,
                bss_section->data_offset, 0,
                ELFW(ST_INFO)(STB_GLOBAL, STT_NOTYPE), 0,
                bss_section->sh_num, L_4439);
#ifndef TCC_TARGET_PE
    /* horrible new standard ldscript defines */
    add_init_array_defines(s1, L_4440);
    add_init_array_defines(s1, L_4441);
    add_init_array_defines(s1, L_4442);
#endif
    ...
    for(i = 1; i < s1->nb_sections; i++) {
        ...
        if (s->sh_type == SHT_PROGBITS &&
            ...
            snprintf(buf, sizeof(buf), L_4443, s->name);
            set_elf_sym(symtab_section,
                        0, 0,
                        ELFW(ST_INFO)(STB_GLOBAL, STT_NOTYPE), 0,
                        s->sh_num, buf);
            snprintf(buf, sizeof(buf), L_4444, s->name);
            set_elf_sym(symtab_section,
                        s->data_offset, 0,
                        ELFW(ST_INFO)(STB_GLOBAL, STT_NOTYPE), 0,
                        s->sh_num, buf);
        ...
        for(j = 0; j < 2; j++) {
            ...
            for(k = 0; k < 5; k++) {
                for(i = 1; i < s1->nb_sections; i++) {
                    ...
                    if (s->sh_type == SHT_RELX) {
#if defined(__FreeBSD__) || defined(__FreeBSD_kernel__)
                        if (!strcmp(strsec->data + s->sh_name, L_4449)) {
                            dyninf->rel_addr = addr;
                            dyninf->rel_size += s->sh_size; /* XXX only first rel. */
                        }
                        if (!strcmp(strsec->data + s->sh_name, L_4450)) {
                           ...
                           int file_offset, int *sec_order)
{
    ...
    case TCC_OUTPUT_EXE:
        ehdr.e_type = ET_EXEC;
        ehdr.e_entry = get_elf_sym_addr(s1, L_4451, 1);
        break;
    case TCC_OUTPUT_DLL:
        ehdr.e_type = ET_DYN;
                              ...
                              ElfW(Phdr) *phdr, int file_offset, int *sec_order)
{
    ...
    if (fd < 0) {
        tcc_error_noabort(L_4452, filename);
        return -1;
    }
    f = fdopen(fd, L_4453);
    if (s1->verbose)
        printf(L_4454, filename);
...
static int elf_output_file(TCCState *s1, const char *filename)
{
	...
	resolve_common_syms(s1);
        ...
        if (!s1->static_link) {
            if (file_type == TCC_OUTPUT_EXE) {
                ...
                const char *elfint = getenv(L_4455);
                if (elfint == NULL)
                    elfint = DEFAULT_ELFINTERP(s1);
                /* add interpreter section only if executable */
                interp = new_section(s1, L_4456, SHT_PROGBITS, SHF_ALLOC);
            ...
            s1->dynsym = new_symtab(s1, L_4457, SHT_DYNSYM, SHF_ALLOC,
                                    L_4458,
                                    L_4459, SHF_ALLOC);
            dynstr = s1->dynsym->link;

            /* add dynamic section */
            dynamic = new_section(s1, L_4460, SHT_DYNAMIC,
                                  SHF_ALLOC | SHF_WRITE);
            dynamic->link = dynstr;
    ...
    strsec = new_section(s1, L_4461, SHT_STRTAB, 0);
    put_elf_str(strsec, L_4462);
                                ...
                                int fd, unsigned long file_offset)
{
    ...
    for(i = 1; i < ehdr.e_shnum; i++) {
        ...
        if (sh->sh_type != SHT_PROGBITS &&
            ...
            strcmp(sh_name, L_4465)
            )
            continue;
	if (seencompressed
	    && (!strncmp(sh_name, L_4466, sizeof(L_4467)-1)
		|| (sh->sh_type == SHT_RELX
		    && !strncmp((char*)strsec + shdr[sh->sh_info].sh_name,
			        L_4468, sizeof(L_4469)-1))))
	  continue;
    ...
    found:
        ...
        if (0 == strcmp(sh_name, L_4473)) {
            stab_index = i;
            goto no_align;
        }
        if (0 == strcmp(sh_name, L_4474)) {
            stabstr_index = i;
            goto no_align;
        }
...
ST_FUNC int tcc_load_archive(TCCState *s1, int fd)
{
    ...
    for(;;) {
        ...
        /* align to even */
        size = (size + 1) & ~1;
        if (!strcmp(ar_name, L_4477)) {
            /* coff symbol table : we handle it */
            if(s1->alacarte_link)
                return tcc_load_alacarte(s1, fd, size, 4);
	} else if (!strcmp(ar_name, L_4478)) {
            if(s1->alacarte_link)
    ...
    for(;;) {
        ...
        if (t == LD_TOK_EOF) {
            ...
            if ((t != LD_TOK_NAME) || (filename[0] != 'l')) {
                tcc_error_noabort(L_4485);
                ret = -1;
                goto lib_parse_error;
            }
            pstrcpy(libname, sizeof libname, &filename[1]);
            if (s1->static_link) {
                snprintf(filename, sizeof filename, L_4486, libname);
            } else {
                snprintf(filename, sizeof filename, L_4487, libname);
            }
        } else if (t != LD_TOK_NAME) {
            tcc_error_noabort(L_4488);
            ret = -1;
            goto lib_parse_error;
        }
        if (!strcmp(filename, L_4489)) {
...
ST_FUNC int tcc_load_ldscript(TCCState *s1)
{
    ...
    for(;;) {
        ...
        if (t == LD_TOK_EOF)
            ...
            return -1;
        if (!strcmp(cmd, L_4490) ||
            !strcmp(cmd, L_4491)) {
            ret = ld_add_file_list(s1, cmd, 0);
            if (ret)
                return ret;
        } else if (!strcmp(cmd, L_4492) ||
                   !strcmp(cmd, L_4493)) {
