#ifndef dL_1201
#define dL_1201
static const char L_1201[]="soft float ABI currently not supported: default to softfp";
static const char L_1202[]="Support for FPA is deprecated and will be removed in next release";
static const char L_1203[]="Support for OABI is deprecated and will be removed in next release";
static const char L_1204[]="/lib/ld-linux-armhf.so.3";
static const char L_1205[]="/lib/ld-linux.so.3";
static const char L_1206[]="compiler error! This happens f.ex. if the compiler\ncan't evaluate constant expressions outside of a function.";
static const char L_1207[]="FIXME: function bigger than 32MB";
static const char L_1208[]="compiler error! register %i is no vfp register";
static const char L_1209[]="compiler error! register %i is no fpa register";
static const char L_1210[]="compiler error! register %i is no int register";
static const char L_1211[]="unexpected condition code";
static const char L_1212[]="unexpected condition code";
static const char L_1213[]="load unimplemented!";
static const char L_1214[]="store unimplemented";
static const char L_1215[]="lvalue_save";
static const char L_1216[]="gen_opi %i unimplemented!";
static const char L_1217[]="unknown fp op %x!";
static const char L_1218[]="unsigned comparison on floats?";
static const char L_1219[]="unknown fp op %x!";
static const char L_1220[]="unimplemented gen_cvt_itof %x!";
static const char L_1221[]="unimplemented gen_cvt_ftoi!";
static const char L_1222[]="alignment is not a power of 2: %i";
#endif
/*
...
again:
  ...
  /* second pass to restore registers that were saved on stack by accident.
     Maybe redundant after the L_1215 patch in tccgen.c:gv() */
  if (++pass < 2)
    goto again;
